...
enum
{
    ...
    WALLEVE_EVENT_PEERNET_REMOVENODE,
...
typedef TYPE_PEERNETEVENT(WALLEVE_EVENT_PEERNET_REMOVENODE,CNetHost,bool) CWalleveEventPeerNetRemoveNode;
...
public:
    ...
    DECLARE_EVENTHANDLER(CWalleveEventPeerNetRemoveNode);
