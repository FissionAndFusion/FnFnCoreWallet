...
public:
    CNode() {}
    CNode(const boost::asio::ip::tcp::endpoint& epIn, const uint256& macAddrIn, const std::string& strNameIn,
...
public:
    ...
    bool GetMacAddress(const boost::asio::ip::tcp::endpoint& ep,uint256& addr);
    bool SetMacAddress(const boost::asio::ip::tcp::endpoint& ep,const uint256& addr);
    void Clear();
    ...
    void AddNewEndPointMac(const boost::asio::ip::tcp::endpoint& ep, const uint256& addr);
