...
public:
    ...
    bool GetLastBlock(const uint256& hashFork,uint256& hashBlock,int32& nHeight,int64& nTime) override;
    bool GetLastBlockTime(const uint256& hashFork,int32 nDepth,std::vector<int64>& vTime) override;
    ...
    bool GetTxLocation(const uint256& txid,uint256& hashFork,int32& nHeight) override;
    ...
    bool FilterTx(const uint256& hashFork, const int32 nDepth, CTxFilter& filter) override;
