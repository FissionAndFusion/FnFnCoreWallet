...
void CForkBlockMaker::ArrangeBlockTx(CBlock& block,const uint256& hashFork,const CBlockMakerProfile& profile)
{

}
    
bool CForkBlockMaker::SignBlock(CBlock& block,const CBlockMakerProfile& profile)
{
    return false;
}
...
bool CForkBlockMaker::CreateDelegatedBlock(CBlock& block,const uint256& hashFork,const CBlockMakerProfile& profile,std::size_t nWeight)
{
    return false;
}
    
bool CForkBlockMaker::CreateProofOfWork(CBlock& block,CBlockMakerHashAlgo* pHashAlgo)
{
    return false;
}
    
void CForkBlockMaker::CreatePiggyback(const CBlockMakerProfile& profile,const CBlockMakerAgreement& agreement,const CBlock& refblock,int nPrevHeight)
{

}
    
void CForkBlockMaker::CreateExtended(const CBlockMakerProfile& profile,const CBlockMakerAgreement& agreement,const std::set<uint256>& setFork,int nPrimaryBlockHeight,int64 nTime)
{

}
    
bool CForkBlockMaker::GetAvailiableDelegatedProfile(const std::vector<CDestination>& vBallot,std::vector<CBlockMakerProfile*>& vProfile)
{
    return false;
}
