...
typedef boost::multi_index_container<
  ...
  boost::multi_index::indexed_by<
    ...
    boost::multi_index::ordered_non_unique<boost::multi_index::member<CForkLink,int32,&CForkLink::nJointHeight> >,
...
public:
    ...
    bool GetJoint(const uint256& hashFork,uint256& hashParent,uint256& hashJoint,int32& nHeight) const override;
