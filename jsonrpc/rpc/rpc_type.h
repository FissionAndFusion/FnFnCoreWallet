...
public:
    ...
    explicit CRPCType(bool b) : fValid(b) {}
public:
...
public:
    CRPCInt64(const CRPCType& o) : CRPCType(o.IsValid()) {}
    CRPCInt64(const int64 i) : i(i), CRPCType(true) {}

public:
    inline operator int64() const { return i; }
...
public:
    CRPCUint64(const CRPCType& o) : CRPCType(o.IsValid()) {}
    CRPCUint64(uint64 u) : u(u), CRPCType(true) {}

public:
    inline operator uint64() const { return u; }
...
public:
    CRPCDouble(const CRPCType& o) : CRPCType(o.IsValid()) {}
    CRPCDouble(double d) : d(d), CRPCType(true) {}
...
public:
    CRPCBool(const CRPCType& o) : CRPCType(o.IsValid()) {}
    CRPCBool(bool b) : b(b), CRPCType(true) {}
...
public:
    CRPCString(const CRPCType& o) : CRPCType(o.IsValid()) {}
    CRPCString(const std::string& s) : s(s), CRPCType(true) {}
    CRPCString(const char* s) : s(s), CRPCType(true) {}
...
public:
    CRPCVector(const CRPCType& o) : CRPCType(o) {}
    CRPCVector(const std::vector<T>& o) : o(o), CRPCType(true) {}

public:
    typedef T value_type;

    inline operator const std::vector<T>&() const { return o; }
