...
public:
    CMvEventPeerData(uint64 nNonceIn,const uint256& hashForkIn,const std::string& identifier="netchannel", const std::string& flowIn = "in")
...
public:
    ...
    std::string flow; //dbpservice data flow dirction:"up"/"down"(dbpservice),"in"/"out"(p2p), default:"in"
};
