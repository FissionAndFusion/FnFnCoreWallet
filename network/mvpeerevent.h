...
public:
    CMvEventPeerData(uint64 nNonceIn,const uint256& hashForkIn,const std::string& identifier="netchannel", const std::string& flowIn = "p2p")
...
public:
    ...
    std::string flow; //dbpservice data flow dirction:"up"/"down"/"p2p", default:"p2p"
};
